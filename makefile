...
OBJS = nc8tr.o displayBase.o displayStdOut.o incu8ator.o sensorBase.o sensorDHT22.o sensoremu.o pugixml.o programWheel.o utils.o elapsedTimeThread.o log.o
EXENAME = nc8tr
EXEC = -o $(EXENAME)
